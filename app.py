...
<div class="main-header">
    ...
    <p>Tác giả: Lưu Thị Lan - Trường Tiểu học Vĩnh Hảo, xã Vĩnh Tuy, tihr Tuyên Quang - ĐT: 0397 189 768</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lưu Thị Lan - Trường Tiểu học Vĩnh Hảo, xã Vĩnh Tuy, tihr Tuyên Quang - ĐT: 0397 189 768</div>", unsafe_allow_html=True)
